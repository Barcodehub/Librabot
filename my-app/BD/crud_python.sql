...
CREATE DATABASE IF NOT EXISTS `crud_python` /*!40100 DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `crud_python`;
...
CREATE TABLE IF NOT EXISTS `users` (
  ...
  `name_surname` varchar(100) CHARACTER SET latin1 COLLATE latin1_general_ci NOT NULL,
  `email_user` varchar(50) CHARACTER SET latin1 COLLATE latin1_general_ci NOT NULL,
  `pass_user` text CHARACTER SET latin1 COLLATE latin1_general_ci NOT NULL,
